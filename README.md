...
**Note 2: This is a final version of Angular and it will be updated time to time.**
...
```bash
# clone our repo
$ git clone https://<username>@pramerica-bitbucket.prudential.com/scm/ng2/scaffolding.git new-project
